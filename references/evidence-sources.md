# Evidence and Nutrition Source Policy

## Nutrition Values

Use the highest available source for each item:

1. The product's nutrition label and net content supplied by the user.
2. The manufacturer, restaurant, retailer, or regulator's current product document.
3. An authoritative food-composition database appropriate to the food and region.
4. A reproducible recipe with named ingredients and quantities.

Keep the source URL or formal citation and access date with every numeric estimate.
